...
menu.outline.outline.main.text.Text = "yiffer"
...
function library:saveConfig()
    ...
    writefile("yiffer/"..tostring(game.GameId).."/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
...
function library:loadConfig()
    ...
    if not isfile("yiffer/"..tostring(game.GameId).."/"..name..".cfg") then
        library:notify("Config file not found!")
        return
    end
    local config = game:GetService("HttpService"):JSONDecode(readfile("yiffer/"..tostring(game.GameId).."/"..name..".cfg"))
...
function library:refreshConfigs()
    local tbl = {}
    for i,v in next, listfiles("yiffer/"..tostring(game.GameId)) do
...
function library:deleteConfig()
    if isfile("yiffer/"..tostring(game.GameId).."/"..library.flags["selected_config"]..".cfg") then
        delfile("yiffer/"..tostring(game.GameId).."/"..library.flags["selected_config"]..".cfg")
        library:refreshConfigs()
    end
end
