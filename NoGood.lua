...
local ver = "0.1 Beta"
--files
if not isfolder("yiffer") then
    makefolder("yiffer")
end
if not isfolder("yiffer/"..tostring(game.GameId)) then
    makefolder("yiffer/"..tostring(game.GameId))
end
--vars
local library,menu,tabholder = loadstring(game:HttpGet("https://raw.githubusercontent.com/Boonnk/BonksRoblox/main/test.lua"))()
...
function onStep()
    ...
    if library.flags["watermark_enabled"] then
        ...
        aloraWatermark.Text = "Yiffer.xyz | "..ver.." | "..hours..":"..minutes..":"..seconds
    end
end
